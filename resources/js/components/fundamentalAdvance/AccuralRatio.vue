        ...
        <div class="sector-selection">
            <div class="card">
                <div class="form-group">
                    ...
                    <v-select v-model="selectedSector" :options="sectors" @update:modelValue="fetchTotalAssetsData"
                        placeholder="Select a sector" :reduce="(sector) => sector.id" label="sectorDescription"
...
export default {
    ...
    methods: {
        ...
        async fetchTotalAssetsData() {
            ...
            try {
                const response = await axios.get("/api/accural-ratio/", {
                    params: {
