...
export default {
    ...
    data() {
        return {
           ...
           tableColumns: [
            ...
            { key: 'cash_flow_ratio', label: 'Cash Flow Ratio' },
    ...
    methods: {
        ...
        getRecommendation(row) {
            ...
            const cashFlowRatioValue = parseFloat(row.cash_flow_ratio);
            const cashFlowRatioRanges = this.cashFlowRatioRatingRanges[sector];

            // === Current Ratio classification ===

            let cashFlowRatioRating = '';
            if (cashFlowRatioRanges && !isNaN(cashFlowRatioValue)) {
            if (cashFlowRatioValue >= cashFlowRatioRanges.best) cashFlowRatioRating = 'Best';
            else if (cashFlowRatioValue >= cashFlowRatioRanges.better[0]) cashFlowRatioRating = 'Better';
            else if (cashFlowRatioValue >= cashFlowRatioRanges.good[0]) cashFlowRatioRating = 'Good';
            else if (cashFlowRatioValue >= cashFlowRatioRanges.neutral[0]) cashFlowRatioRating = 'Neutral';
            else if (cashFlowRatioValue >= cashFlowRatioRanges.weak[0]) cashFlowRatioRating = 'Weak';
            else cashFlowRatioRating = 'Worst';
            }

            return cashFlowRatioRating || 'N/A';
