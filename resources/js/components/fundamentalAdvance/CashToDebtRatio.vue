    ...
    data() {
        return {
           ...
           tableColumns: [
            ...
            { key: 'cash_flow_to_debt_ratio', label: 'Cash Flow To Debt Ratio' },
    ...
    methods: {
        async getFinancialMetrics() {
            ...
            try {
                ...
                const url = `https://laganisutra.com/api/cash-flow-ratio?sector=${encodeURIComponent(sector || 'all')}`;
        ...
        isNumericField(key) {
            const numericFields = ['operating_cash_flow', 'cash_flow_to_debt_ratio'];
        ...
        getRecommendation(row) {
            ...
            const value = parseFloat(row.cash_flow_to_debt_ratio);
