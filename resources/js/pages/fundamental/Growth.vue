...
export default {
    ...
    data() {
        return {
            description:
                "बृद्धि खण्डले कम्पनीको भविष्यको विस्तार क्षमता र बिक्री बृद्धिको दर मापन गर्छ। उच्च बृद्धि दर भएका कम्पनीहरू आकर्षक लगानी बन्छन्।",
