            ...
            <div class="card-body p-0">
                ...
                <div class="main-tab-section">
                    <div class="d-flex align-items-center gap-1 mb-1">
                        <h3 class="mb-0">Risk Detection</h3>
...
const categories = [{ name: "Beneish M-Score", component: BeneishM }]
...
export default {
    ...
    data() {
        return {
            description: "जोखिम पहिचान खण्डले कम्पनीमा लुकेका वित्तीय समस्याहरू र धोखाधडीको सम्भावना पत्ता लगाउन मद्दत गर्छ।",
