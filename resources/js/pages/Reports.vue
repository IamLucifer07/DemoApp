  ...
  methods: {
    ...
    mapMetricsToUI(apiData, sectorInfo) {
      ...
      getRatingHoverText(item, rating) {
        ...
        if (item.name === "Current Ratio") {
          const hoverTexts = {
            "High Growth" : 'उत्कृष्ट छोटो अवधि वित्तीय अवस्था। कम्पनीसँग हालका दायित्वहरू ढाक्न पर्याप्तभन्दा बढी सम्पत्ति छ।',
            "Steady Growth" : 'बलियो तरलता स्थिति। सजिलैसँग छोटो अवधि दायित्वहरू पूरा गर्न सक्छ।',
            "Stable" : 'पर्याप्त तरलता छ तर निगरानी आवश्यक पर्न सक्छ। सुरक्षित सीमा भन्दा अलि माथि।',
            "Declining" : 'मुस्किलले पर्याप्त तरलता। दायित्वहरू तिर्न सक्छ तर थप सुरक्षाको गुन्जायस कम।',
            "Loss Making" : 'गम्भीर वित्तीय संकट। पुनःसंरचना वा नयाँ वित्तीय सहयोग बिना छोटो अवधि दायित्वहरू तिर्न असमर्थ हुन सक्छ।'
          };
          return hoverTexts[rating];
        }
        if (item.name === "Quick Ratio") {
          const hoverTexts = {
            "Excellent": "श्रेष्ठ तरलता: अत्यधिक तरलता जसले सूची बिक्रीमा निर्भर रहनु पर्दैन, बलियो वित्तीय अवस्था र न्यून डिफल्ट जोखिमको संकेत गर्दछ।",
            "Strong": "स्वस्थ तरलता: आरामदायक तरलता सुरक्षा भण्डार, साना अवरोधहरूलाई पनि सञ्चालनमा असर नपारिकन सामना गर्न सक्षम।",
            "Adequate": "न्यूनतम सुरक्षा स्तर: न्यूनतम दायित्वहरू पूरा गर्न सक्ने तर सुरक्षाको लागि थप भण्डार छैन, जोखिम टार्न स्थिर नगद प्रवाह आवश्यक।",
            "Caution": "तरलता जोखिमको संकेत: प्राप्तीमा ढिलाइ वा आकस्मिक खर्चहरूबाट असर पर्न सक्ने सम्भावना, सम्भावित तरलता तनाव देखिन्छ।",
            "Weak": "उच्च जोखिम: अत्यधिक डिफल्ट जोखिम, सूची बिक्री वा बाह्य वित्तीय स्रोतहरूमा निर्भर रहने अवस्था।",
            "Critical": "गम्भीर संकट: दिवालियापनको नजिक, आपतकालीन हस्तक्षेप बिना ऋण तिर्न असमर्थ हुने अवस्था।"
          };
          return hoverTexts[rating];
        }
        if (item.name === "Cash Ratio") {
          const hoverTexts = {
            ...
            "Neutral": "सीमित सुरक्षा: नगदले ३०-५०% ऋण मात्र ढाक्छ; भुक्तानी ढिलाइ वा आम्दानी घट्दा असर पर्ने सम्भावना।",
        ...
        if (item.name === "Operating Cash Flow Ratio") {
          const hoverTexts = {
            ...
            "Neutral": "सीमित पर्याप्तता: प्राप्ती ढिलो वा भुक्तानी चाँडो भएमा कहिलेकाहीं पुनःवित्तीयकरण आवश्यक पर्न सक्छ।",
